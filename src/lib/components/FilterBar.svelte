...
<div class="filter-bar">
  <div class="filter-header">
    ...
    {#if collapsible}
      <button class="toggle-button" on:click={toggleExpanded} aria-label={expanded ? 'Collapse filters' : 'Expand filters'}>
    ...
    <div class="filter-content">
      {#if selectedCount > 0}
        <div class="active-filters">
          <span class="active-count">{selectedCount} active filter{selectedCount !== 1 ? 's' : ''}</span>

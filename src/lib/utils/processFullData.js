/**
 * Process Full Data Script
 * 
 * This script reads the full raw CSV data, processes it using the utility functions,
 * and writes the result to comments.json.
 * 
 * Run with: node src/lib/utils/processFullData.js
 */
...
// Path to the raw data file - use the full version
const rawDataPath = path.resolve(__dirname, '../../../plans/raw-data/Coding Full.csv');
...
try {
  ...
  const output = {
    ...
    _meta: {
      ...
      source: "plans/raw-data/Coding Full.csv"
    }
  };

<script>
	...
	onMount(() => {
		...
		if (rose) {
			...
			const idolComments = commentsData.comments.filter(
				(comment) => comment.mentionedIdols && comment.mentionedIdols.includes(rose.id)
			);

			// Calculate sentiment distribution
			const relevantComments = idolComments.filter(
				(c) => c.sentiment !== 'off-topic' && c.sentiment !== 'unknown'
			);
...
<div class="home-page">
	<div class="hero-section">
		<div class="hero-content">
			...
			<p class="hero-subtitle">
				An interactive visualization of research on K-pop idols' English accents and how they are
				perceived by fans
			</p>
	...
	<div class="research-overview">
		...
		<p class="section-description">
			This interactive web app visualizes findings from the research paper "I Want to Be Born with
			That Pronunciation": Metalinguistic Comments About K-Pop Idols' Inner Circle Accents by Jihye
			Kim and Luoxiangyu Zhang.
		</p>
	...
	<div class="sentiment-section">
		...
		<p class="section-description">
			The research found that fans overwhelmingly express positive sentiment toward K-pop idols'
			English accents.
		</p>
		...
		<div class="sample-section">
			...
			<div class="sample-comments">
				...
				{#each featuredComments as comment}
					<CommentCard
						text={comment.language === 'Korean' && comment.translation
							? comment.translation
							: comment.text}
		...
		<div class="features-grid">
			<div class="feature-card">
				...
				<p class="feature-description">
					Watch the four YouTube videos analyzed in the study and explore the comments about idols'
					English accents.
				</p>
			...
			<div class="feature-card">
				...
				<p class="feature-description">
					Learn about the seven K-pop idols featured in the study and their English accent
					characteristics.
				</p>
			...
			<div class="feature-card">
				...
				<p class="feature-description">
					Browse and filter the comments analyzed in the research paper to discover patterns and
					insights.
				</p>
	...
	<div class="about-section">
		...
		<p class="about-text">
			This interactive web application was created as a proof of concept for making academic
			research more accessible, engaging, and interactive. It transforms the findings from a
			linguistics research paper into a visual, explorable format that helps users understand how
		...
		<p class="about-text">
			...
			complex findings in an intuitive, visually appealing way that doesn't require specialized
			knowledge of research methods or academic conventions.
		</p>
